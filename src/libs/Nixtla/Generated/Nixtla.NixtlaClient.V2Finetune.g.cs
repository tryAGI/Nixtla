            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Nixtla.FinetuneOutput.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Nixtla.FinetuneOutput.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
