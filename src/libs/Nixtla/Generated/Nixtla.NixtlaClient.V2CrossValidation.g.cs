            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Nixtla.CrossValidationOutput.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Nixtla.CrossValidationOutput.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
