            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Nixtla.ForecastOutput.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Nixtla.ForecastOutput.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
