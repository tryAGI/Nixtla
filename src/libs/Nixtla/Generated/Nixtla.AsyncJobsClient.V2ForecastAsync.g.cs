...
namespace Nixtla
{
    public partial class AsyncJobsClient
    {
        ...
        private static readonly global::Nixtla.EndPointSecurityRequirement s_V2ForecastAsyncSecurityRequirement0 =
        ...
        private static readonly global::Nixtla.EndPointSecurityRequirement[] s_V2ForecastAsyncSecurityRequirements =
            new global::Nixtla.EndPointSecurityRequirement[]
            {                s_V2ForecastAsyncSecurityRequirement0,
            };
        partial void PrepareV2ForecastAsyncArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Nixtla.ForecastAsyncRequest request);
        partial void PrepareV2ForecastAsyncRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Nixtla.ForecastAsyncRequest request);
        partial void ProcessV2ForecastAsyncResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV2ForecastAsyncResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Submit an async forecast job<br/>
        /// Queues a forecast job and returns immediately with its `job_id`. The job runs in a sandbox; poll `GET /v2/forecast/jobs/{job_id}` for its state and result. Accepts the same body as the synchronous endpoint plus an optional `job_options`.
        /// </summary>
        /// <param name="request"></param>
        /// <param name="requestOptions">Per-request overrides such as headers, query parameters, timeout, retries, and response buffering.</param>
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Nixtla.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Nixtla.AsyncJobSubmitResponse> V2ForecastAsyncAsync(

            global::Nixtla.ForecastAsyncRequest request,
            global::Nixtla.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await V2ForecastAsyncAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Nixtla.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Nixtla.AutoSDKHttpResponse<global::Nixtla.AsyncJobSubmitResponse>> V2ForecastAsyncAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV2ForecastAsyncArguments(
            ...
            var __authorizations = global::Nixtla.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V2ForecastAsyncSecurityRequirements,
                operationName: "V2ForecastAsyncAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Nixtla.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Nixtla.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V2ForecastAsync",
                                methodName: "V2ForecastAsyncAsync",
                                pathTemplate: "\"/v2/forecast/async\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV2ForecastAsyncResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Nixtla.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV2ForecastAsyncResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Nixtla.AsyncJobSubmitResponse> V2ForecastAsyncAsync(
            ...
            global::Nixtla.ForecastAsyncRequestFinetuneLoss? finetuneLoss = default,
            int? finetuneDepth = default,
            string? finetunedModelId = default,
            bool? featureContributions = default,
            global::Nixtla.ForecastAsyncRequestFeatureContributionsType? featureContributionsType = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Nixtla.ForecastAsyncRequest
            {
                Series = series,
                Freq = freq,
                H = h,
            ...
            return await V2ForecastAsyncAsync(
                request: __request,
                requestOptions: requestOptions,
