...
namespace Nixtla
{
    public partial class AsyncJobsClient
    {
        ...
        private static readonly global::Nixtla.EndPointSecurityRequirement s_ListAsyncJobsV2AsyncJobsGetSecurityRequirement0 =
        ...
        private static readonly global::Nixtla.EndPointSecurityRequirement[] s_ListAsyncJobsV2AsyncJobsGetSecurityRequirements =
            new global::Nixtla.EndPointSecurityRequirement[]
            {                s_ListAsyncJobsV2AsyncJobsGetSecurityRequirement0,
            };
        partial void PrepareListAsyncJobsV2AsyncJobsGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Collections.Generic.IList<global::Nixtla.AsyncJobStatus>? status,
            ref int? pageSize,
            ref string? pageToken);
        partial void PrepareListAsyncJobsV2AsyncJobsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Collections.Generic.IList<global::Nixtla.AsyncJobStatus>? status,
            int? pageSize,
            string? pageToken);
        partial void ProcessListAsyncJobsV2AsyncJobsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListAsyncJobsV2AsyncJobsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Nixtla.AsyncJobsResponse> ListAsyncJobsV2AsyncJobsGetAsync(
        ...
        {
            var __response = await ListAsyncJobsV2AsyncJobsGetAsResponseAsync(
                status: status,
                pageSize: pageSize,
                pageToken: pageToken,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Nixtla.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Nixtla.AutoSDKHttpResponse<global::Nixtla.AsyncJobsResponse>> ListAsyncJobsV2AsyncJobsGetAsResponseAsync(
            global::System.Collections.Generic.IList<global::Nixtla.AsyncJobStatus>? status = default,
            int? pageSize = default,
            string? pageToken = default,
            global::Nixtla.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListAsyncJobsV2AsyncJobsGetArguments(
            ...
            var __authorizations = global::Nixtla.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListAsyncJobsV2AsyncJobsGetSecurityRequirements,
                operationName: "ListAsyncJobsV2AsyncJobsGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListAsyncJobsV2AsyncJobsGetRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Nixtla.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Nixtla.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListAsyncJobsV2AsyncJobsGet",
                                methodName: "ListAsyncJobsV2AsyncJobsGetAsync",
                                pathTemplate: "\"/v2/async/jobs\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Nixtla.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListAsyncJobsV2AsyncJobsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Nixtla.AsyncJobsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Nixtla.AutoSDKHttpResponse<global::Nixtla.AsyncJobsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Nixtla.AsyncJobsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
