...
namespace Nixtla
{
    ...
    /// </summary>
    public enum ForecastInputFeatureContributionsType
    {
        /// <summary>
    ...
    /// </summary>
    public static class ForecastInputFeatureContributionsTypeExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this ForecastInputFeatureContributionsType value)
        {
            return value switch
            {
                ForecastInputFeatureContributionsType.Granger => "granger",
                ForecastInputFeatureContributionsType.Intervention => "intervention",
                ForecastInputFeatureContributionsType.Shapley => "shapley",
                ForecastInputFeatureContributionsType.TransferEntropy => "transfer_entropy",
        ...
        /// </summary>
        public static ForecastInputFeatureContributionsType? ToEnum(string value)
        {
            return value switch
            {
                "granger" => ForecastInputFeatureContributionsType.Granger,
                "intervention" => ForecastInputFeatureContributionsType.Intervention,
                "shapley" => ForecastInputFeatureContributionsType.Shapley,
                "transfer_entropy" => ForecastInputFeatureContributionsType.TransferEntropy,
                _ => null,
            };
        }
    }
